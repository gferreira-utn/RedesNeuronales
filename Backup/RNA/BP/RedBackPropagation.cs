    ...
    public class RedBackPropagation
    {
        ...
        public double ObtenerSalida(int neurona)
        {
            if (neurona >= 0 && neurona < this.salida.Neuronas)
                return this.salida.Valor[neurona];
            else
                return 0.0;
        }
